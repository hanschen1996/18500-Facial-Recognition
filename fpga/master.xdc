...
set_property IOSTANDARD LVCMOS25 [get_ports uart_tx_async]
set_property LOC K24 [get_ports uart_tx_async]
set_property IOSTANDARD LVCMOS25 [get_ports uart_rx_async]
set_property LOC M19 [get_ports uart_rx_async]
