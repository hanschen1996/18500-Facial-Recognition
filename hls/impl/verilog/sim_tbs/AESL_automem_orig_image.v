...
module AESL_automem_orig_image (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "c.detect_face.autotvin_orig_image.dat", 
    TV_OUT = "impl_rtl.detect_face.autotvout_orig_image.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 15;
parameter DEPTH = 32'd 19200;
parameter DLY = 0.1;
