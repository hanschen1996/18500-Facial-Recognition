...
entity cascade_classifietde_rom is 
    generic(
             dwidth     : integer := 4; 
             awidth     : integer := 12; 
...
architecture rtl of cascade_classifietde_rom is 
...
entity cascade_classifietde is
    generic (
        DataWidth : INTEGER := 4;
...
architecture arch of cascade_classifietde is
    component cascade_classifietde_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cascade_classifietde_rom_U :  component cascade_classifietde_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
