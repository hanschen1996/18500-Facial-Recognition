...
entity detect_face_cascade_classifier_RECT3_Y_rom is 
    generic(
             dwidth     : integer := 5; 
             awidth     : integer := 12; 
...
architecture rtl of detect_face_cascade_classifier_RECT3_Y_rom is 
...
entity detect_face_cascade_classifier_RECT3_Y is
    generic (
        DataWidth : INTEGER := 5;
...
architecture arch of detect_face_cascade_classifier_RECT3_Y is
    component detect_face_cascade_classifier_RECT3_Y_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    detect_face_cascade_classifier_RECT3_Y_rom_U :  component detect_face_cascade_classifier_RECT3_Y_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
