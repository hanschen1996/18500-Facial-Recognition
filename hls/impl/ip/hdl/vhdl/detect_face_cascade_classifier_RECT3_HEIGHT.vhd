...
entity detect_face_cascade_classifier_RECT3_HEIGHT_rom is 
    generic(
             dwidth     : integer := 4; 
             awidth     : integer := 12; 
...
architecture rtl of detect_face_cascade_classifier_RECT3_HEIGHT_rom is 
...
entity detect_face_cascade_classifier_RECT3_HEIGHT is
    generic (
        DataWidth : INTEGER := 4;
...
architecture arch of detect_face_cascade_classifier_RECT3_HEIGHT is
    component detect_face_cascade_classifier_RECT3_HEIGHT_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    detect_face_cascade_classifier_RECT3_HEIGHT_rom_U :  component detect_face_cascade_classifier_RECT3_HEIGHT_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
