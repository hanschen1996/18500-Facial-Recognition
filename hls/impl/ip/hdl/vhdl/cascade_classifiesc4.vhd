...
entity cascade_classifiesc4_rom is 
    generic(
             dwidth     : integer := 4; 
             awidth     : integer := 12; 
...
architecture rtl of cascade_classifiesc4_rom is 
...
entity cascade_classifiesc4 is
    generic (
        DataWidth : INTEGER := 4;
...
architecture arch of cascade_classifiesc4 is
    component cascade_classifiesc4_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cascade_classifiesc4_rom_U :  component cascade_classifiesc4_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
