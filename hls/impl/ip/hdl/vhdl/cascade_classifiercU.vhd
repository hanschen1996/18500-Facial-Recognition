...
entity cascade_classifiercU_rom is 
    generic(
             dwidth     : integer := 5; 
             awidth     : integer := 12; 
...
architecture rtl of cascade_classifiercU_rom is 
...
entity cascade_classifiercU is
    generic (
        DataWidth : INTEGER := 5;
...
architecture arch of cascade_classifiercU is
    component cascade_classifiercU_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    cascade_classifiercU_rom_U :  component cascade_classifiercU_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
