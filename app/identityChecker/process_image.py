...
def add_face(name, label):
    ...
    for filename in files:
        ...
        crop_img.save("%s/subject%d.%s_%d_20x20.pgm"%(TRAIN_IMG_DIR, label, name, success_count))
        success_count += 1
        ...
        # draw the bounding box and output the file to display for webapp
    ...
    for i in range(success_count, TRAIN_SIZE):
        ...
        face_labels.append(label)
        valid_img.save("%s/subject%d.%s_%d_20x20.pgm"%(TRAIN_IMG_DIR, label, name, i))
